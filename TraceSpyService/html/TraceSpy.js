            ...
            if (xmlhttp.status == 200) {
                ...
                if (traces.Records != null) {
                    for (var i = 0; i < traces.Records.length; i++) {
                        ...
                        newRow.insertCell(3).appendChild(document.createTextNode(record.ProcessId));
                        newRow.insertCell(4).appendChild(document.createTextNode(record.Text));
                        newRow.insertCell(5).appendChild(document.createTextNode(''));
                        logTable.lastIndex = record.Index;
